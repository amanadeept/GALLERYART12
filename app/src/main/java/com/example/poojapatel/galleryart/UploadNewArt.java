...
public class UploadNewArt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgArt = (ImageView) findViewById(R.id.img_art);
        ...
        if(myIntent.hasExtra("artName")){
            ...
            artId = Integer.parseInt(myIntent.getStringExtra("artId").toString());
        ...
        buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int userId = Integer.parseInt(session.get("user_id").toString());
