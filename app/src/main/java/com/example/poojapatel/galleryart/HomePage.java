...
int categoryId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonUpdateProfile=(Button)findViewById(R.id.button_update_profile);
        buttonMyArtWork = (Button)findViewById(R.id.button_my_art_work);
        buttonMyCart = (Button)findViewById(R.id.button_my_cart);
